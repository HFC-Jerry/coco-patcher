% coco-patcher(SECTION) | User Commands
%
% "June 19 2025"
...
coco-patcher - program to do something

# SYNOPSIS

**coco-patcher** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**coco-patcher** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **coco-patcher** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**coco-patcher** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    coco-patcher. See **foo.conf**(5) for further details.
...
**coco-patcher** provides some return codes, that can be used in scripts:
